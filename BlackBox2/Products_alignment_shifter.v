module Products_Alignment_Shifter (
    ...
    // Extend products to 163 bits with zero extension (unsigned magnitudes)
    wire [162:0] product0_ext = {56'd0, product0};
    wire [162:0] product1_ext = {56'd0, product1};
    wire [162:0] product2_ext = {56'd0, product2};
    wire [162:0] product3_ext = {56'd0, product3};

    // Mode-based shifting
    // DP mode: only product0 is used, no inter-product alignment needed
    // PD2 mode: only product0 and product1 (or product0 and product3 per paper)
    // PD4 mode: all four products need alignment
